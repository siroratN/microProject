...
const Home = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get("http://localhost:5001/inventory/getAllProducts");
  ...
  return (
    <>
      <div className="grid grid-cols-3 p-4">
        <div className="flex items-center text-violet-800 cursor-pointer bg-opacity-50 bg-violet-400 p-2 w-32 rounded-md" onClick={() => navigate("/addProduct")}>
          <PlusIcon />
          ...
          products.map((product) => (
            ...
            >
              <img
                ...
                src={product.image || "https://cdn-dhpod.nitrocdn.com/ciLqvltLGzQghvUohHGIDrpOdslNfbyn/assets/images/optimized/rev-2300483/www.mtkwood.com/wp-content/uploads/2020/08/464232-PFPXVY-410-scaled.jpg"}
                alt={product.name}
              />
